...
namespace ASP_FinalExam_Net6.Controllers
{
    public class DepartmentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DepartmentId,Name,EmployeeCount")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DepartmentId,Name,EmployeeCount")] Department department)
        {
